...
export const PriorityIcon = ({ priority }: PriorityIconProps): React.JSX.Element => (
	<>
		{priority === Priority.High && <Task01Icon style={{ color: 'red' }} />}
		{priority === Priority.Low && <Task01Icon style={{ color: 'black' }} />}
		{priority === Priority.Medium && <Task01Icon style={{ color: 'blue' }} />}
	</>
);
